...
2. If complexity_score <= 40 → select TESSERACT
3. If complexity_score <= 75 → select PADDLEOCR
4. If complexity_score > 75 → select OPENAI_VISION_LLM

## Engine Descriptions:
- TESSERACT: Fast, works well on clean printed text, simple layouts
- PADDLEOCR: Better for structured tables, multi-column layouts, moderate complexity
...
{"engine": "TESSERACT|PADDLEOCR|OPENAI_VISION_LLM", "reason": "brief explanation"}
