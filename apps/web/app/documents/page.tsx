    ...
    <main className="min-h-screen bg-gray-50 py-10 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <a href="/" className="text-sm bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
            + Upload New
          </a>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl border p-12 text-center">
            ...
            <a href="/" className="mt-4 inline-block text-blue-600 hover:underline">Upload your first invoice →</a>
          </div>
        ) : (
