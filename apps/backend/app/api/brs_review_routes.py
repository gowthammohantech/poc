...
from app.services.file_storage_service import path_to_public_url
...
async def get_brs_review(document_id: str):
    ...
    for p in pages:
        ...
        page_urls.append(path_to_public_url(path))
    ...
    return {
        ...
        "page_urls": page_urls,
        "brs": brs_data,
        "bank_statement": brs_json.get("bank_statement", {}),
        "coa": brs_json.get("coa", []),
        "ledger": brs_json.get("ledger", []),
