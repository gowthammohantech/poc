...
_REGISTRY: dict[str, MailConnector] = {_gmail.provider: _gmail}

# Not a real mailbox; only offered when explicitly switched on for development.
if os.getenv("CONNECTOR_ENABLE_FAKE") == "1":
    _fake = FakeConnector()
    _REGISTRY[_fake.provider] = _fake
